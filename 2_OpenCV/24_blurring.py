...
# 이미지 밝기의 중앙값을 기준으로 threshold를 정하는 휴리스틱(경험적 방법)를 통해서 Canny threshold를 조절하거나 다른 방법으로 threshold를 결정하는 경우가 많음(lower, upper)
...
# Canny 전에 가볍게 Gaussion Blur를 적용해 잡음 영향을 줄임
